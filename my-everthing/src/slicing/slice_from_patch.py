...
def build_graph_from_file_code(graph_type="all"):
    ...
    code_filepath_list = get_code_filepath()
...
def get_single_code_filepath_from_criterion(criterion:dict):
    ...
    code_filepath = os.path.join(config.CODE_ROOT, commit_id_short, filename)
...
def slice_from_patch():
    ...
    graph_type = "all"
    build_graph_from_file_code(graph_type=graph_type)
